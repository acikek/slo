...
public class Slo implements ModInitializer {
	...
	public static void connect(Minecraft minecraft, Screen parent, ServerLevelSummary serverLevelSummary) throws IOException, ExecutionException, InterruptedException {
		...
		new Thread(() -> tryReadServerInput(minecraft, parent, serverLevelSummary, process)).start();
	...
	public static void tryReadServerInput(Minecraft minecraft, Screen parent, ServerLevelSummary serverLevelSummary, Process process) {
